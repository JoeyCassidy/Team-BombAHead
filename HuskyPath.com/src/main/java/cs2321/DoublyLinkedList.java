...
//	}
	 ...
	 * @param e the information to put in the node
...
//		}
	 ...
	 * @param e the information to be put in the new node
...
//				just does stitching
	...
	class DLterable implements Iterator<Position<E>> {
		...
		@Override
		public void remove() {
			// TODO had to put this in to prevent DLterable from having an error
		}
//			node<E> position = first;
//			boolean removable = false;
//			
